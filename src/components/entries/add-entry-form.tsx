        ...
        {type === "expense" && !editing && (
          <div className="flex gap-2 empty:hidden">
            ...
            <VoiceButton
              onHeard={(transcript) => {
                /*
                 * The people first, because what they were said in is words
                 * the description must not keep: "Anna paid the 120 taxi,
                 * split with me and Jonas" is a taxi, and the rest of it is a
                 * chip. A clause whose names did not resolve claims nothing,
                 * so those words fall through to the description as they
                 * always did.
                 */
                 ...
                 * that named nobody clears the last one's offer with them:
                 * the chips answer for the sentence on screen, never for the
                 * one before it.
                 */
                setNamedPeople(
