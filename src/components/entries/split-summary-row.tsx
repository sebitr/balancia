...
export function SplitSummaryRow({
  ...
  return (
    <button
      type="button"
      onClick={onOpen}
      className="grid w-full grid-cols-[1fr_auto] items-center gap-x-3 gap-y-1 rounded-[17px] bg-card p-3.5 text-left shadow-hairline transition-colors active:bg-accent"
    >
